 ...
 *  level is enabled at compile time. See CMAKE variable `MYSQLPOOL_LOG_LEVEL_STR`.
 */
class Logger {
    public:
...
#define MYSQLPOOL_LOG_INFO_(msg)      BOOST_LOG_TRIVIAL(info) << msg
#define MYSQLPOOL_LOG_DEBUG_(msg)     BOOST_LOG_TRIVIAL(debug) << msg
#define MYSQLPOOL_LOG_TRACE_(msg)     BOOST_LOG_TRIVIAL(trace) << msg
...
#elif defined MYSQLPOOL_LOG_WITH_LOGFAULT
...
#define MYSQLPOOL_LOG_ERROR_(msg)     LFLOG_ERROR << msg
#define MYSQLPOOL_LOG_WARN_(msg)      LFLOG_WARN << msg
#define MYSQLPOOL_LOG_INFO_(msg)      LFLOG_INFO << msg
#define MYSQLPOOL_LOG_DEBUG_(msg)     LFLOG_DEBUG << msg
#define MYSQLPOOL_LOG_TRACE_(msg)     LFLOG_TRACE << msg

#define MYSQLPOOL_TEST_LOGGING_INCLUDE
#define MYSQLPOOL_TEST_LOGGING_SETUP(level) MysqlpoolTestStartLogger(level)
...
#elif defined MYSQLPOOL_LOG_WITH_CLOG

#include <iostream>

#define MYSQLPOOL_TEST_LOGGING_SETUP(level)

#define MYSQLPOOL_LOG_ERROR_(msg)     std::clog << "ERROR " << msg << std::endl
#define MYSQLPOOL_LOG_WARN_(msg)      std::clog << "WARN  " << msg << std::endl
#define MYSQLPOOL_LOG_INFO_(msg)      std::clog << "INFO  " << msg << std::endl
#define MYSQLPOOL_LOG_DEBUG_(msg)     std::clog << "DEBUG " << msg << std::endl
#define MYSQLPOOL_LOG_TRACE_(msg)     std::clog << "TRACE " << msg << std::endl
...
#   ifdef MYSQLPOOL_LOG_ERROR
#       define MYSQLPOOL_LOG_ERROR_(msg)     MYSQLPOOL_LOG_ERROR << msg
#   else
#       define MYSQLPOOL_LOG_ERROR_(msg)
#   endif

#   ifdef MYSQLPOOL_LOG_WARN
#       define MYSQLPOOL_LOG_WARN_(msg)     MYSQLPOOL_LOG_WARN << msg
#   else
#       define MYSQLPOOL_LOG_WARN_(msg)
#   endif


#   ifdef MYSQLPOOL_LOG_DEBUG
#       define MYSQLPOOL_LOG_DEBUG_(msg)     MYSQLPOOL_LOG_DEBUG << msg
#   else
#       define MYSQLPOOL_LOG_DEBUG_(msg)
#   endif


#   ifdef MYSQLPOOL_LOG_INFO
#       define MYSQLPOOL_LOG_INFO_(msg)     MYSQLPOOL_LOG_INFO << msg
#   else
#       define MYSQLPOOL_LOG_INFO_(msg)
#   endif


#   ifdef MYSQLPOOL_LOG_TRACE
#       define MYSQLPOOL_LOG_TRACE_(msg)     MYSQLPOOL_LOG_TRACE << msg
#   else
...
// Limit the log-level to MYSQLPOOL_LOG_LEVEL
// No need to spam production logs.
// By using macros, we also eliminate CPU cycles on irrelevant log statements

#if (MYSQLPOOL_LOG_LEVEL < 5)
#   undef MYSQLPOOL_LOG_TRACE_
#   define MYSQLPOOL_LOG_TRACE_(msg)
#endif

#if (MYSQLPOOL_LOG_LEVEL < 4)
#   undef MYSQLPOOL_LOG_DEBUG_
#   define MYSQLPOOL_LOG_DEBUG_(msg)
#endif
...
#   undef MYSQLPOOL_LOG_WARN_
#   define MYSQLPOOL_LOG_WARN_(msg)
#endif

#if (MYSQLPOOL_LOG_LEVEL < 1)
#   undef MYSQLPOOL_LOG_ERROR_
#   define MYSQLPOOL_LOG_ERROR_(msg)
#endif
